...
write('analysis/live-news-decision-audit-current.json',{schema_version:'1.4.0',generated_at:new Date().toISOString(),authoritative:true,policy:'SUBJECT_AWARE_PLAYER_EVENT_BINDING; VERIFIED SAME_TEAM_QB EVENTS MAY PROPAGATE AS CONNECTED OFFENSE CONTEXT; STARTER CHANGES ARE NONDIRECTIONAL UNLESS EVIDENCE SUPPORTS GOOD/BAD IMPACT; STATIC BASELINE UNTOUCHED; SEASON_LONG NUMERIC MOVES REQUIRE VALIDATED QUANTITATIVE SUPPORT',universe:expected,counts,decisions});
