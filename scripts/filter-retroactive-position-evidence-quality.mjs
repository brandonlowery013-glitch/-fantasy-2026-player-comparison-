...
// Cross-player roundup contamination regressions.
...
if(qualify({headline:'NFL roundup',matched_context:'te brock bowers missed practice for personal reasons signings p jack bouwmeester signed with the rams',categories:['new_team','coach_signal']},'TE','Brock Bowers').keep)throw new Error('Regression: unrelated signing contaminated Brock Bowers');
