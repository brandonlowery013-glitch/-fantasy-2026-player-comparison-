...
console.log(JSON.stringify({result:report.result,total_2025_holdout_scores:evalN,selected_families:report.selected_families,blocked},null,2));if(blocked.length)process.exit(1);
