...
must(index.includes('operations-dashboard.html'),'main navigation missing Operations link');
...
must(['READY','WAITING_FOR_SOURCE','WAITING_FOR_FORECAST','WAITING_FOR_FINAL','WAITING_FOR_SETTLEMENT','STALE','BLOCKED'].includes(pipeline.overall_status),'invalid pipeline state');
const report={step:21,status:'PASS',operations_linked:true,upstream_ledgers:required,pipeline_status:pipeline.overall_status,calibration_decision:gov.decision,logic_duplicated:false};
