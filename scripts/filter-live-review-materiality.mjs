...
ledger.schema_version='1.2.2';ledger.materiality_filter={method:'PLAYER_LOCAL_CONTEXT_PLUS_14_DAY_FRESHNESS_AND_NFL_FANOUT_GUARD',material_mentions_before:before,material_mentions_after:after,tracked_players_triggered:trackedSignals.length,connected_mentions_before:connectedBefore,connected_mentions_after:connectedAfter,nfl_broad_body_fanout_limit:NFL_BODY_PLAYER_FANOUT_MAX,nfl_broad_body_suppressions:nflBroadBodySuppressions,generated_at:new Date().toISOString()};
