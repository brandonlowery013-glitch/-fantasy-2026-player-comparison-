...
const expected=Number(cfg.authoritative_player_count);
...
if(c.expected_player_universe!==expected)fail(`universe ${c.expected_player_universe} != authoritative ${expected}`);
...
console.log(JSON.stringify({result:'PASS',schema:c.schema_version,expected_player_universe:c.expected_player_universe,authoritative_player_count:expected,bridge_available:false,production_numeric_authority:0}));
